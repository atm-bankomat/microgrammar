...
import { MatchingMachine, Microgrammart } from "../src/Microgrammar";
...
describe("Microgrammar", () => {
    ...
    it("literal", () => {
        const content = "foo ";
        const mg = Microgrammart.fromDefinitions({
            name: "foo",
        });
    ...
    it("allows valid call to function", () => {
        const content = "foo ";
        const validMg = Microgrammart.fromDefinitions({
            content: makeMg(),
        });
    ...
    it("stop after match with arrow function", () => {
        ...
        const mg = Microgrammart.fromDefinitions<Named>({
            name: /[A-Z][a-z]+/,
        });
    ...
    it("microgrammars can compose: no match", () => {
        ...
        const nested = Microgrammart.fromDefinitions({
            pigs: names,
        });
    ...
    it("flatten definitions into parent", () => {
        ...
        const mg = Microgrammart.fromDefinitions<CatsDogsAndPigs>({
            dogs: names,
            _separator: "****",
            cats: names,
            _separator2: "****",
...
class StringGrammar {
    ...
    public static readonly stringGrammar: Microgrammart<any> = Microgrammart.fromDefinitions<any>({
        foo: ctx => {
