...
describe("MicrogrammarUpdateTest", () => {
    ...
    it("update nested element", () => {
        const person = Microgrammark.fromDefinitions({
            name: /[a-zA-Z0-9]+/,
            address: {
                number: Integer,
                street: /[a-zA-Z0-9]+/,
        ...
        const updater = Microgrammark.updatinateMatch(result[0], line);
    ...
    it("update multiple deeply nested elements in succession", () => {
        ...
        const updatable = Microgrammark.updatable<any>(results, line);
    ...
    it.skip("can update a rep element", () => {
        ...
        const mg = Microgrammark.fromString("love ${listItems}", {
            listItems: {
        ...
        if (isSuccessfulMatch(match)) {
            ...
            const updater: any = Microgrammark.updatinateMatch(mmmm, input);
