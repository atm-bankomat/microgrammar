...
export const AnyAnnotation = Microgrammart.fromDefinitions<RawAnnotation>({
    _at: "@",
...
export const ChangeControlledMethodGrammar = Microgrammart.fromDefinitions<ChangeControlledMethod>({
...
export const GrammarWithOnlyARep = Microgrammart.fromDefinitions<any>({
